//Here we will create all SVG as react components
...
export const Design = (props) => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" {...props}>
			<path
				d="M0 0v6h1v1H0v6h1v1H0v6h20v-6h-1v-1h1V7h-1V6h1V0H0zm1 1h18v4H1V1zm1 1v1h1V2H2zm2 0v1h1V2H4zM2 6h16v1H2V6zM1 8h18v4H1V8zm1 1v1h1V9H2zm2 0v1h1V9H4zm-2 4h16v1H2v-1zm-1 2h18v4H1v-4zm1 1v1h1v-1H2zm2 0v1h1v-1H4z"
				fill={props.fill}
			/>
		</svg>
	);
